...
const OTPSquareIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-gray-400">
        <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 12h1.5l1.5 1.5V12H11"/><path d="M17 12h-2l-1 1.5v-1.5h-1.5"/>
    </svg>
);
...
const SuccessIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-12 w-12 text-green-500 mx-auto mb-4">
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 rounded-xl shadow-lg">
        {success ? (
          <div className="text-center">
            ...
            <p className="text-gray-300">Your password has been reset. Redirecting to sign-in...</p>
          </div>
        ) : (
          <>
            <div className="text-center">
